...
// @route 	GET api/profile (no need :id because we have a token when u are logged in)
// @des		  Get cuurent user's profile
// @access 	Private
...
// @route 	POST api/profile (no need :id because we have a token when u are logged in)
